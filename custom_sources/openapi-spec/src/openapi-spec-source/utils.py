...
def main():
    ...
    parser.add_argument('-apiout', '--api-spec-output-folder', type=str, action='store', help='Specify the api-spec output folder, if command is `download_api_specs`', required=False)
